...
import 'package:fullstackecommerce/src/exceptions/async_error_logger.dart';
import 'package:fullstackecommerce/src/features/authentication/data/auth_repository.dart';
import 'package:fullstackecommerce/src/features/authentication/data/fake_auth_repository.dart';
import 'package:fullstackecommerce/src/features/cart/data/local/fake_local_cart_repository.dart';
import 'package:fullstackecommerce/src/features/cart/data/local/local_cart_repository.dart';
import 'package:fullstackecommerce/src/features/cart/data/remote/fake_remote_cart_repository.dart';
import 'package:fullstackecommerce/src/features/cart/data/remote/remote_cart_repository.dart';
import 'package:fullstackecommerce/src/features/checkout/application/checkout_service.dart';
import 'package:fullstackecommerce/src/features/checkout/application/fake_checkout_service.dart';
import 'package:fullstackecommerce/src/features/orders/data/fake_orders_repository.dart';
import 'package:fullstackecommerce/src/features/orders/data/orders_repository.dart';
import 'package:fullstackecommerce/src/features/products/data/fake_products_repository.dart';
import 'package:fullstackecommerce/src/features/products/data/products_repository.dart';
import 'package:fullstackecommerce/src/features/reviews/application/reviews_service.dart';
import 'package:fullstackecommerce/src/features/reviews/data/fake_reviews_repository.dart';
import 'package:fullstackecommerce/src/features/reviews/data/reviews_repository.dart';
